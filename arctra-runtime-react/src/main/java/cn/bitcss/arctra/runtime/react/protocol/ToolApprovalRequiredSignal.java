 ...
 *
 * <p><b>Java-public for cross-package access</b> - internal to arctra-runtime-react only. Not part of framework public API.
 *
 * <p><b>Semantics:</b>
 * <ul>
 ...
 * @author arctra
 */
public final class ToolApprovalRequiredSignal extends RuntimeException {
   ...
   */
  public ToolApprovalRequiredSignal(GovernanceToolCallingAdvisor.SuspensionState state) {
   ...
   */
  public GovernanceToolCallingAdvisor.SuspensionState state() {
    return state;
  }
}
