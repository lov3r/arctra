 ...
 * @since M6-T2C
 */
public final class CompositeExecutionEventListener implements ExecutionEventListener {
   ...
   */
  public CompositeExecutionEventListener(List<ExecutionEventListener> listeners) {
